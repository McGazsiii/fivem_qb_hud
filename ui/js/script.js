    ...
    if (!data.pauseMenuOn) {
      ...
      if (data.action === 'ui') {
        if (data.ui) {
          ...
          $('#ppchk').on('change', function () {
            this.checked ? $('.hud-pp').fadeIn('fast') : $('.hud-pp').fadeOut('fast');
          });
        } else {
        ...
        if (data.ganglabel == 'No Gang') {
          $('.hud-gang').hide();
        } else {
          $('.hud-gang').show();
          $('.hud-gang span').text(data.ganglabel + ' - ' + data.ganggrade);
        }
        $('.hud-clock span').text(data.clock);
        $('.hud-pp span').text(data.pp + ' PP');
      }
    } else {
      $('.hud-container').hide();
    }
